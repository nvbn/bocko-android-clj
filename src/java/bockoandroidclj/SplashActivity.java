...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("bockoandroidclj.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("bockoandroidclj.BockoActivity");
                    } catch (ClassNotFoundException e) {
                        Log.e(TAG, "Failed loading BockoActivity", e);
                    }
